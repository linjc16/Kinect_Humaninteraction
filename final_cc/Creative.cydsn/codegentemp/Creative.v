// ======================================================================
// Creative.v generated from TopDesign.cysch
// 07/19/2018 at 22:29
...
`ifdef WARP
`define CY_BLK_DIR "F:\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0"
`include "F:\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "F:\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0"
`include "F:\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "F:\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal"
`include "F:\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`else
`define CY_BLK_DIR "F:\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal"
`include "F:\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`endif
...
module UART_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("dfeb9ec5-f13f-4465-bacb-428d12859cb8/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
`ifdef WARP
`define CY_BLK_DIR "F:\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0"
`include "F:\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0\not_v1_0.v"
`else
`define CY_BLK_DIR "F:\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0"
`include "F:\PSoC\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0\not_v1_0.v"
`endif
...
module top ;
    ...
    UART_v2_50_0 UART_Blue (
        ...
        .rx_data(Net_57),
        .rx_clk(Net_58));
    defparam UART_Blue.Address1 = 0;
    defparam UART_Blue.Address2 = 0;
    defparam UART_Blue.EnIntRXInterrupt = 0;
    defparam UART_Blue.EnIntTXInterrupt = 0;
    defparam UART_Blue.FlowControl = 0;
    defparam UART_Blue.HalfDuplexEn = 0;
    defparam UART_Blue.HwTXEnSignal = 0;
    defparam UART_Blue.NumDataBits = 8;
    defparam UART_Blue.NumStopBits = 1;
    defparam UART_Blue.ParityType = 0;
    defparam UART_Blue.RXEnable = 1;
    defparam UART_Blue.TXEnable = 1;
	...
	cy_clock_v1_0
		#(.id("40ff68a3-cb54-48ad-9c47-977384cb22e2"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("13020833333.3333"),
		  .is_direct(0),
	...
	assign tmpOE__bufoe_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_270} : {Net_270};
	...
	assign tmpOE__bufoe_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_135} : {Net_135};


    assign Net_135 = ~Net_270;

    ZeroTerminal ZeroTerminal_1 (
        .z(Net_305));

	wire [0:0] tmpOE__SIR_net;
	wire [0:0] tmpFB_0__SIR_net;
	wire [0:0] tmpINTERRUPT_0__SIR_net;
	electrical [0:0] tmpSIOVREF__SIR_net;

	cy_psoc3_pins_v1_10
		#(.id("c082efa3-3db6-4f89-86ae-a3090fbe86b6"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SIR
		 (.oe(tmpOE__SIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SIR_net[0:0]}),
		  .io({Net_302}),
		  .siovref(tmpSIOVREF__SIR_net),
		  .interrupt({tmpINTERRUPT_0__SIR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__to_Rx_2_net;
	wire [0:0] tmpFB_0__to_Rx_2_net;
	wire [0:0] tmpINTERRUPT_0__to_Rx_2_net;
	electrical [0:0] tmpSIOVREF__to_Rx_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("264be2d3-9481-494b-8d9c-c1905a45e9cc"),
		  ...
		  .input_buffer_sel(2'b00))
		to_Rx_2
		 (.oe(tmpOE__to_Rx_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__to_Rx_2_net[0:0]}),
		  .io({Net_316}),
		  .siovref(tmpSIOVREF__to_Rx_2_net),
		  .interrupt({tmpINTERRUPT_0__to_Rx_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__to_Rx_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
